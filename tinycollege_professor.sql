...
CREATE TABLE `professor` (
  ...
  `PROF_INITIAL` varchar(5) DEFAULT NULL,
...
INSERT INTO `professor` VALUES ('1','1','magic','epic','botong','igme','a','igme@mail.com'),('2','2','basketball','legend','lumas','carding','e','card@mail.com'),('3','3','sipa','master','kuleg','marie','o','marie@mail.com');
